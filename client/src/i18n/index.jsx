...
export const STRINGS = {
  bn: {
    ...
    selectCorporation: 'আপনার সিটি কর্পোরেশন নির্বাচন করুন',
    selectCorporationHint: 'আপনি শুধু নির্বাচিত কর্পোরেশনের সমস্যাগুলো দেখতে পাবেন',
    enterConsole: 'প্রবেশ করুন',
    demoNotice: 'ডেমো সংস্করণ — কোনো পাসওয়ার্ড প্রয়োজন নেই',
    backToCitizen: '← নাগরিক অ্যাপে ফিরে যান',
    // admin console
    workQueue: 'কার্যতালিকা',
    signedInAs: 'প্রশাসক',
    switchCorporation: 'কর্পোরেশন বদলান',
    signOut: 'লগ আউট',
  ...
  en: {
    ...
    selectCorporation: 'Select your city corporation',
    selectCorporationHint: 'You will only see issues inside the corporation you choose',
    enterConsole: 'Enter console',
    demoNotice: 'Demo build — no password required',
